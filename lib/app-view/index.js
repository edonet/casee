...
class AppView extends Component {
    ...
    componentWillReceiveProps(props, context) {
        ...
        // 更新路由上下文
        updateRouteContext(context.pathname);

        // 获取路径
        if (props.path) {
            this.$$path = history.resolve(props.path, context.pathname);
        } else {
            this.$$path = history.resolve('./404', context.pathname);
        }
    ...
    updateView(props) {
        ...
        console.log(props.title, this.$$path, matched);
